...
const Converter = (): ReactElement | null => {
  ...
  return (
    <div className="flex justify-center dark:bg-gray-800 dark:text-white">
      <div className="bg-gray-50 lg:max-w-screen-lg w-full my-6 p-4 flex flex-col items-center gap-5 dark:bg-gray-700 rounded h-fit-content">
        ...
        <div>
          <div className="flex items-center bg-white dark:bg-gray-800  p-4 gap-10 rounded-lg">
            ...
            <div className="flex gap-4 items-center">
              <Select code="USD" name="ამერიკული დოლარი" />
              <input
                className="outline-none border-b h-8 dark:bg-gray-800"
                type="text"
                placeholder="დოლარი"
